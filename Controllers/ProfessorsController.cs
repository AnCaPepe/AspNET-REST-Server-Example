...
namespace school_server.Controllers
{
    ...
    {
        private readonly IProfessorsRepository _retrievesRepository;
        private readonly IChangesRepository _changesRepository;
        public ProfessorsController( IProfessorsRepository retrievesRepository, IChangesRepository changesRepository )
        {
